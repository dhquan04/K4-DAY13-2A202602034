...
class FakeLLM:
    ...
    def generate(self, prompt: str) -> FakeResponse:
        ...
        if STATE["cost_spike"]:
            output_tokens *= 4
        if STATE["cost_optimization"]:
            # The cap protects the output-priced part of the request from runaway responses.
            output_tokens = min(output_tokens, int(os.getenv("MAX_OUTPUT_TOKENS", "160")))
        answer = (
